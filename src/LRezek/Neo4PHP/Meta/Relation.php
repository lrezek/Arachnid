 ...
 *
 * This is a meta class that defines the meta for a Relation. It is a meta object that extends \LRezek\Neo4PHP\Meta\GraphElement,
...
class Relation extends GraphElement
{
    ...
    private $repositoryClass = 'LRezek\\Neo4PHP\\Repository';
     ...
     * @throws \LRezek\Neo4PHP\Exception Thrown if the relation already has a start.
     */
     ...
     * @throws \LRezek\Neo4PHP\Exception Thrown if the relation already has a end.
     */
     ...
     *
     * @throws \LRezek\Neo4PHP\Exception Thrown if the object does not have a start/end property.
     */
    function validate()
    {
