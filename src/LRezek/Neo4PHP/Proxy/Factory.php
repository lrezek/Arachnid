...
class Factory
{
     ...
     * @param \LRezek\Neo4PHP\Meta\Repository $repository The meta repository.
     ...
     * LRezek\Neo4PHP\Proxy\Entity. This class will be generated and stored in the directory specified by the $proxyDir
     ...
     *
     * @param \LRezek\Neo4PHP\Meta\GraphElement $meta The meta for the entity object being proxied.
     * @return mixed An instance of the proxy class.
     * @throws \LRezek\Neo4PHP\Exception If something goes wrong in file writing.
     */
    private function createProxy(\LRezek\Neo4PHP\Meta\GraphElement $meta)
    {
...
class $proxyClass extends $className implements LRezek\\Neo4PHP\\Proxy\\Entity
{
    ...
    private function __load(\$name, \$propertyName)
    {
        ...
        if (! \$this->neo4j_meta) {
            throw new \\LRezek\\Neo4PHP\\Exception('Proxy not fully initialized.');
        }
