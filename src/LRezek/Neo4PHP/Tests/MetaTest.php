...
use LRezek\Neo4PHP\Meta\Repository as MetaRepository;
...
class MetaTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testGetIndexedProperties()
    {
        ...
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\User');
    ...
    {
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWith');
    ...
    function testAnnotationlessEntity() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\AnnotationlessEntity');
    }
    ...
    function testNodeMultipleAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\UserMultipleAuto');
    ...
    function testNodeNoAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\UserNoAuto');
    }
    ...
    function testRelationMultipleAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithMultipleAuto');
    ...
    function testRelationNoAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithNoAuto');
    }
    ...
    function testRelationMultipleStart() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithMultipleStart');
    ...
    function testRelationNoStart() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithNoStart');
    ...
    function testRelationMultipleEnd() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithMultipleEnd');
    ...
    function testNoEndRelation() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\FriendsWithNoEnd');
    ...
    function testScalarProperty() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4PHP\\Tests\\Entity\\UserDifferentPropertyFormats');
