...
class Property
{
    ...
    const AUTO = 'LRezek\\Neo4PHP\\Annotation\\Auto';
    const PROPERTY = 'LRezek\\Neo4PHP\\Annotation\\Property';
    const INDEX = 'LRezek\\Neo4PHP\\Annotation\\Index';

    //Relation types
    const START = 'LRezek\\Neo4PHP\\Annotation\\Start';
    const END = 'LRezek\\Neo4PHP\\Annotation\\End';

    /** @var \Doctrine\Common\Annotations\AnnotationReader The annotation reader to use.*/
    private $reader;

    /** @var \LRezek\Neo4PHP\Annotation\Property Property Annotation object.*/
    private $property;
     ...
     * @param \LRezek\Neo4PHP\Annotation\Property $property The property to use.
     */
