...
class EntityManagerTest extends DatabaseTestCase
{
    ...
    function testNodeFlush()
    {
        ...
        $queryString = 'MATCH (movie:`LRezek\Neo4PHP\Tests\Entity\User` {firstName:"Arnold"}) RETURN movie;';
        $query = new EM_QUERY($em->getClient(), $queryString);
        $result = $query->getResultSet();
    ...
    function testNodeReload()
    {
        ...
        {
            if($val != 'LRezek\\Neo4PHP\\Proxy\\Entity')
            {
                $this->fail();
            }
        }
    ...
    function testNodeUpdate() {
        ...
        $id = $this->id;
        $queryString = "MATCH (movie:`LRezek\\Neo4PHP\\Tests\\Entity\\User` {firstName:'Arnie', testId:'$id'}) RETURN movie;";
        $query = new EM_QUERY($em->getClient(), $queryString);
        $result = $query->getResultSet();
    ...
    function testRelationStartNodePropertyUpdate() {
        ...
        $id = $this->id;
        $queryString = "MATCH (movie:`LRezek\\Neo4PHP\\Tests\\Entity\\User` {firstName:'Arnold', testId:'$id'}) RETURN movie;";
        $query = new EM_QUERY($em->getClient(), $queryString);
        $result = $query->getResultSet();
    ...
    function testRelationEndNodePropertyUpdate() {
        ...
        //Query for the node with everyman
        $id = $this->id;
        $queryString = "MATCH (movie:`LRezek\\Neo4PHP\\Tests\\Entity\\User` {firstName:'Thomas Sean', testId:'$id'}) RETURN movie;";
        $query = new EM_QUERY($em->getClient(), $queryString);
        $result = $query->getResultSet();
        ...
        $id = $this->id;
        $queryString = "MATCH (movie:`LRezek\\Neo4PHP\\Tests\\Entity\\User` {firstName:'Sean', testId:'$id'}) RETURN movie;";
        $query = new EM_QUERY($em->getClient(), $queryString);
        $result = $query->getResultSet();
