...
abstract class GraphElement
{
    ...
    private $className;
    /** @var \LRezek\Neo4j\Meta\Property The graph element's primary key property.*/
    private $primaryKey;
    /** @var \LRezek\Neo4j\Meta\Property[] The graph element's properties.*/
    private $properties = array();
    /** @var \LRezek\Neo4j\Meta\Property[] The graph element's indexed properties.*/
     ...
     *
     * @return \LRezek\Neo4j\Meta\Property[] The array of indexed properties.
     */
     ...
     *
     * @return \LRezek\Neo4j\Meta\Property[] The array of properties.
     */
     ...
     *
     * @param string $name
     * @return \LRezek\Neo4j\Meta\Property|null The property, or null if it's not found.
     */
     ...
     *
     * @param \LRezek\Neo4j\Meta\Property $property The property to set as primary key.
     * @throws \LRezek\Neo4j\Exception "Class contains multiple targets for @auto" exception.
     */
     ...
     *
     * @throws \LRezek\Neo4j\Exception "Class contains no @auto property" exception.
     */
    function validate()
    {
        if (! $this->primaryKey)
