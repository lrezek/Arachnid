...
class QueryTest extends DatabaseTestCase
{
    ...
    function testCypherQueryMatchNodeGetList()
    {
        ...
        $set = $em->createCypherQuery()
            ->match('(movie:`LRezek\Neo4j\Tests\Entity\User`)')
    ...
    function testCypherQueryStartWithNodeGetList() {
        ...
        //Grab a node
        $user = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findOneByFirstName('Edward');
    ...
    function testCypherQueryStartWithQuery() {
        ...
        $set = $em->createCypherQuery()
            ->startWithQuery('movie','LRezek\\Neo4j\\Tests\\Entity\\User', 'firstName:Edward')
            ->where('movie.testId="'.$this->id.'"')
            ->end('movie')
            ->getList();
    ...
    function testCypherQueryStartWithLookup() {
        ...
        $set = $em->createCypherQuery()
            ->startWithLookup('movie', 'LRezek\\Neo4j\\Tests\\Entity\\User', 'firstName', 'Edward')
            ->where('movie.testId="'.$this->id.'"')
            ->end('movie')
            ->getList();
    ...
    function testCypherQueryMatchRelationGetOne()
    {
        ...
        $set = $em->createCypherQuery()
            ->match("(n {firstName:'Angelina'})-[r:`LRezek\\Neo4j\\Tests\\Entity\\FriendsWith`]->(m {firstName:'Edward'})")
            ->end('r')
            ->getOne();
