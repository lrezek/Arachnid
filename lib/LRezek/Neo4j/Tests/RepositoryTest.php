...
use LRezek\Neo4j\Tests\Entity\FriendsWith;
use LRezek\Neo4j\Tests\Entity\User;
...
class RepositoryTest extends DatabaseTestCase
{
    ...
    function testNodeFindOneByProperty()
    {
        ...
        //Find a node
        $em = $this->getEntityManager();
        $repo = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User');
    ...
    function testRelationFindOneByProperty()
    {
        ...
        //Query for relation
        $em = $this->getEntityManager();
        $repo = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith');
    ...
    function testNodeFindOneByCriteria()
    {
        ...
        //Find said node
        $repo = $this->getEntityManager()->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User');
    ...
    function testRelationFindOneByStartNodeProperty() {
        ...
        //Find the Brad node
        $brad = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findOneByFirstName('Brad');

        $t = microtime(true);

        //Find his sibling relation
        $rel = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findOneByFrom($brad);
    ...
    function testRelationFindOneByEndNodeProperty() {
        ...
        $em = $this->getEntityManager();
        $c = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findOneByFirstName('Christian');

        $t = microtime(true);

        //Find his sibling relation
        $rel = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findOneByTo($c);
    ...
    function testNodeFindOneByWhenEmpty() {
        ...
        $user = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findOneByFirstName('Jennifer');
    ...
    function testRelationFindOneByWhenEmpty() {
        ...
        //The database is empty, do the query
        $user = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findOneBySince('2050');
    ...
    function testRelationFindOneByStartNodeCriteria() {
        ...
        //Find his sibling relation
        $rel = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findOneBy(array('from' => $brad));
    ...
    function testRelationFindOneByEndNodeCriteria() {
        ...
        //Find his sibling relation
        $rel = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findOneBy(array('to' => $c));
    ...
    function testNodeFindByProperty() {
        ...
        //Find the 3 nodes
        $nodes = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findByFirstName("Bradley")->toArray();
    ...
    function testRelationFindByProperty()
    {
        ...
        $t = microtime(true);
        $relations = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findBySince("2050")->toArray();
        $this->printTime(__FUNCTION__, (microtime(true) - $t));
    ...
    function testNodeFindByCriteria() {
        ...
        //Find the 3 nodes
        $nodes = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findBy(array('firstName' => 'Uma', 'lastName' => 'Therman'))->toArray();
    ...
    function testRelationFindByCriteria()
    {
        ...
        $relations = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findBy(array('since' => '2051'))->toArray();
    ...
    function testNodeFindByWhenEmpty() {
        ...
        //Do the query
        $users = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\User')->findBy(array('firstName' => 'Martha'))->toArray();
    ...
    function testRelationFindByWhenEmpty() {
        ...
        //Do the query
        $users = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findBy(array('since' => '3000'))->toArray();
    ...
    function testRelationFindByStartNodeProperty() {
        ...
        $t = microtime(true);
        $rels = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findByFrom($jam)->toArray();
        $this->printTime(__FUNCTION__, (microtime(true) - $t));
    ...
    function testRelationFindByEndNodeProperty() {
        ...
        $t = microtime(true);
        $rels = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findByTo($jerry)->toArray();
        $this->printTime(__FUNCTION__, (microtime(true) - $t));
    ...
    function testRelationFindByStartNodeCriteria() {
        ...
        $rels = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findBy(array('from' => $john))->toArray();
    ...
    function testRelationFindByEndNodeCriteria() {
        ...
        //Find his sibling relation
        $rels = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith')->findBy(array('to' => $simon))->toArray();
    ...
    function testNodeFindAll() {
        ...
        $t = microtime(true);
        $nodes = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\Person')->findAll()->toArray();
        $this->printTime(__FUNCTION__, (microtime(true) - $t));
    ...
    function testRelationFindAll() {
        ...
        $rels = $em->getRepository('LRezek\\Neo4j\\Tests\\Entity\\Likes')->findAll()->toArray();
