...
class MetaTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testGetIndexedProperties()
    {
        ...
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\User');
    ...
    {
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWith');
    ...
    function testAnnotationlessEntity() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\AnnotationlessEntity');
    }
    ...
    function testNodeMultipleAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\UserMultipleAuto');
    ...
    function testNodeNoAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\UserNoAuto');
    }
    ...
    function testRelationMultipleAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithMultipleAuto');
    ...
    function testRelationNoAuto() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithNoAuto');
    }
    ...
    function testRelationMultipleStart() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithMultipleStart');
    ...
    function testRelationNoStart() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithNoStart');
    ...
    function testRelationMultipleEnd() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithMultipleEnd');
    ...
    function testNoEndRelation() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\FriendsWithNoEnd');
    ...
    function testScalarProperty() {
        ...
        $repo = new MetaRepository;
        $meta = $repo->fromClass('LRezek\\Neo4j\\Tests\\Entity\\UserDifferentPropertyFormats');
