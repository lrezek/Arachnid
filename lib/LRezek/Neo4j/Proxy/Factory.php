...
class Factory
{
     ...
     * @param \LRezek\Neo4j\Meta\Repository $repository The meta repository.
...
class $proxyClass extends $className implements LRezek\\Neo4j\\Proxy\\Entity
{
    ...
    private function __load(\$name, \$propertyName)
    {
        ...
        if (! \$this->neo4j_meta) {
            throw new \\LRezek\\Neo4j\\Exception('Proxy not fully initialized.');
        }
