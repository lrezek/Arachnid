...
use LRezek\Neo4j\Meta\Node;
use LRezek\Neo4j\Meta\Relation;
use LRezek\Neo4j\Query\LuceneQueryProcessor;
...
class Repository
{
    /** @var \LRezek\Neo4j\Meta\GraphElement The meta information for the graph element. */
    private $meta;

    /** @var \Everyman\Neo4j\Index\NodeIndex|\Everyman\Neo4j\Index\RelationshipIndex The index info for the class. */
    private $index;

    /** @var \LRezek\Neo4j\EntityManager The entity manager. */
